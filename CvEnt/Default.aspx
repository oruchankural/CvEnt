<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvEnt.Default" %>
...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="cv/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="cv/css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="cv/css/fontawesome-all.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
...
<body>
    <div class="sidenav text-center">
		<div class="side_top">
			<img src="cv/images/about.jpg" alt="news image" class="img-fluid navimg">
			<h1 class="top_hd mt-2"><a href="index.html">Oruç Han KURAL</a></h1>
			<p class="top_hdp mt-2">Back-end Developer</p>
        </div>
		<!-- header -->
        <header>
			<div class="nav-top">
